...
const TheHeaderDropdown = ({ studentAuth: { isLoggdedInStudent }, logout }) => {
  const studentLinks = (    
    <Fragment>
     <a>
      <CDropdownItem>
...
> 
  ...
  >
    ...
    <Fragment>{ isLoggdedInStudent ? studentLinks : adminLinks }</Fragment>
    </CDropdownMenu>
  </CDropdown>
  </div>
  )
...
const mapStateToProps = state=> ({
  studentAuth: state.studentAuth.isLoggedInStudent,
})
