...
class PaypalButton extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      client: {
        sandbox:    'AaLgWT2mzVerEuCHGSyE_xbg_V1vTdKYNyCd6mdQSaOx0iJ4sYkoBOPCbUGGTTW0K7VG0oLHEN8kdQHI', // sandbox client ID
        production: 'AaLgWT2mzVerEuCHGSyE_xbg_V1vTdKYNyCd6mdQSaOx0iJ4sYkoBOPCbUGGTTW0K7VG0oLHEN8kdQHI' // production client ID
      },
